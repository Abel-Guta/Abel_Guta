        ...
        skills: {
            ...
            },
            {
                ...
                skills: [
                    ...
                    { name: "Supabase", icon: <IconBrandMysql stroke={1.5} /> },
                    { name: "MongoDB", icon: <IconBrandMongodb stroke={1.5} /> },
                    { name: "Firestore", icon: <IconBrandNeo4j /> },
                ],
            },
            {
                ...
                skills: [
                    ...
                    { name: "ShadCN", icon: <IconBrandReddis /> },
                    { name: "Firebase", icon: <IconBrandFirebase stroke={1.5} /> },
                    { name: "TanstackQuery", icon: <IconBrandRabbitMQ /> },
                    {name:'orval'}
                ]
            }
        ]
